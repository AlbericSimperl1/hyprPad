...
#ifndef HYPRPADCLIENT_SWIFT_H
#define HYPRPADCLIENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="hyprPadClient",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13hyprPadClient21SampleBufferVideoView")
@interface SampleBufferVideoView : UIView
